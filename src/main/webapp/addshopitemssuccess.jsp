...
<div class="cartSuccess boxS w1190">
    <div class="CSArea">
        <h6>
            <em></em><span>恭喜您，加入购物车成功！</span>
        </h6>
        <p>
            您的商品加入购物车成功，赶快分享给好友一起购物吧！
        </p>
    </div>
    <div class="CSsubmit">

        <a class="left" href="<%=path%>/showgoodslist?page=1">继续购物>GO</a>
        <a class="right" href="<%=path%>/is/selectshopitems" target="_self">查看购物车</a>
    </div>
</div>
<!-- 底部 -->
<div class="foot">
