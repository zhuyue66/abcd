...
<div class="OrderInfow w1190 boxS">
    <div class="OrderInfo">
        ...
        <form action="<%=path %>/is/cancel" id="cancel" method="post">
            <input name="uuid" value="${ uuid }" style="display: none;">

            <div >
                <li style="display: flex;  flex-direction: row-reverse;">
                    <a style="font-size:16px"  href="javascript:void(0);" onclick="document.getElementById('cancel').submit()" >取消订单</a>
            </div>
        </form>
        ...
        <div class="OrderInAreadown">
            ...
            <a href="<%=path %>/is/selectallorders" class="right">我的订单 &gt;</a>
        </div>
    </div>
</div>
<div class="wayw w1190 boxS">
    <div class="way">
        <form id="frm" action="<%=path%>/is/cartpay" method="post">
            <h3>
                支付金额 ：<b>￥${fsum }</b>
                ...
                <ul class="clearfix">
                    <li class="clearfix">
                        ...
                        <p class="checkbox checked">
                            <img src="<%=path%>/images/zhifubao.png" alt="">
                            <em></em>
                        </p>
                    </li>
                </ul>
                <a href="javascript:void(0)" onclick="document.getElementById('frm').submit()">用支付宝支付</a>
            </div>
        </form>
    </div>
</div>
