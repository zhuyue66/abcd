...
<header class="wrap-all">
    <div class="head center_1200">
        ...
        <div class="headLeft">
            <div class="hello">
                <a href="showgoodslist?page=1"> <em></em> <span>淘宝首页</span> <span>嗨，淘宝欢迎您！</span>
                </a>
            </div>
            <div class="user">
                ...
                <!-- 判断是否登录 -->
                <c:choose>
                    <c:when test="${empty sessionScope.nowuser }"><a target="_self" href="login.jsp">登录</a></c:when>
                    <c:otherwise ><a id="nowuser">用户:${sessionScope.nowuser.userName}</a></c:otherwise>
                </c:choose>
                <span>|</span> <a
        ...
        <div class="headRight">
            <ul>
                <li><a href="<%=path %>/is/selectallorders">我的订单</a></li><span>|</span>
                <li class="erWrap">
                    <strong></strong>
                    <a href="#">个人中心</a>
                    <em></em>
...
<div class="logoAndSearch w1190 textWarp">
    <!-- logo -->
    <div class="logo">
        <a href="<%=request.getContextPath() %>/showgoodslist?page=1" target="_self">淘宝网</a>
    </div>
    <!-- 搜索 -->
    <div class="search">
        <div class="txt">
    ...
    <!--购物车-->
    <a href="<%=path %>/is/selectshopitems" class="buy_car">
        <p>购物车</p>
        <em>0</em>
    </a>
    <!-- 新会员 -->
    ...
    <div class="center_1200 nav_list_wrap">
        ...
        <div class="nav_list_parent">
            ...
            <ul class="nav_list clearfix">
                <!-- 右边导航菜单-->
                <li>
                    <a href="<%=request.getContextPath()%>/showgoodslist?page=1">首 页</a>
                </li>
                <li>
...
<div class="MeSubNavW">
    <ul class="MeSubNav clearfix textWarp w1190">
        ...
        <li>&gt;</li>
        <li><a target="_self" href="<%=path %>/is/selectallorders">我的订单</a></li>
    </ul>
</div>
<!-- 主要内容 -->
<div class="MeMainW">
        ...
        <div class="MeArea clearfix">
            ...
            <div class="MeLeftNav">
                <div class="Mehead">
                    <div class="pic"></div>
                    <div class="txt">
                        <p class="userName">${sessionScope.nowuser.userName}</p>
            ...
            <div class="MeRightArea">
                ...
                <div class="personArea">
                    ...
                    <div class="MeorderArea ">
                        <!-- 我的订单的上面导航 -->
                        <ol class="persontab" id="persontab">
                            <li><a href="<%=path %>/is/selectallorders">全部订单</a></li>
                            <li class="current"><a href="<%=path%>/is/selectwaitpayorders">待付款</a></li>
                            <li><a href="">海关清关</a></li>
                            <li><a href="">待发货</a></li>
                            <li><a href="">待收货</a></li>
                            <li><a href="">待评论</a></li>
                        ...
                        <div class="sect">
                            <ul>
                                <li class="sectTime">订单编号</li>
                                <li class="sectDetail">手机号码</li>
                                <li class="consignee" style="width: 55px; ">收货地址</li>
                                <li class="sum">时间</li>
                        ...
                        <form id="frm" action="<%=path %>/is/addorder" method="post">
                            ...
                            <div class="MeOrder">
                                ...
                                <c:forEach items="${list }" var="v">
                                    ...
                                    <table
                                            style="border: 1px solid #EDEDED; width: 900px; margin-top: 10px">
                                        <tr class="nexttrshowhide"
                                            style="height: 40px; background-color: #F1F1F1">

                                            <td style="width: 315px">${v.order_id }</td>
                                            <td style="width: 100px">${v.order_phone }</td>
                                            <td style="width: 160px">${v.order_address }</td>
                                            <td style="width: 160px">${v.order_time }</td>
                                            <input checked="checked" style="display: none" name="orderaddressid" type="radio" value="${v.recipients_id }">

                                            <td>
                                                <a href="">取消订单</a>
                                                <a href="javascript:void(0)" onclick="document.getElementById('frm').submit()">去付款</a>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="5">
                                                <table>
                                                    ...
                                                    <c:forEach items="${v.dlist }" var="v2">
                                                        <tr>
                                                            <td style="width: 150px;"><img
                                                                    style="width: 100px; height: 100px"
                                                                    src="<%=path %>/images/${v2.goods_img }" alt=""></td>
                                                            <td style="width: 260px;">${v2.goods_name }</td>
                                                            <td style="width: 100px;">总额￥${v2.detail_price*v2.detail_num }</td>
                                                            <td style="width: 100px;"><p class="ing">待付款</p></td>
                                                            <td style="width: 100px;"></td>
                                                            <input checked="checked" style="display: none" name="orderaddressid" type="radio" value="${v2.detail_goods }">
                                                        </tr>
                                                    </c:forEach>
                                                </table>
                                            </td>
...
<footer>
    <div class="up">
        <div class="txt textWarp  w1190">
            <ul>
                <li><a target="_blank" href="../../haitao">关于淘宝海淘</a></li>
                ...
                <li><a target="_blank" href="../../publicBenefit">淘宝公益</a></li>
