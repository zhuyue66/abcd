                ...
                <div class="personArea">
                    ...
                    <div class="MeorderArea ">
                        ...
                        <ol class="persontab">
                            ...
                            <li><a href="<%=request.getContextPath()%>/is/selectwaitpayorders">待付款</a></li>
                            <li><a href="">海关清关</a></li>
                            <li><a href="">待发货</a></li>
                            <li><a href="">待收货</a></li>
                            <li><a href="">待评论</a></li>
                        ...
                        <div class="MeOrder">
                            <c:forEach items="${list }" var="v">
                                <table style="border: 1px solid #EDEDED; width: 900px; margin-top: 10px">
                                    <tr class="nexttrshowhide" style="height: 40px; background-color: #F1F1F1">
                                        ...
                                        <td><c:choose>
                                            <c:when test="${v.order_status==1 }"><button type="button" style="color: red;">待支付</button>
                                            </c:when>
                                            <c:when test="${v.order_status==3 }"><button type="button">待发货</button></c:when>
                                                ...
                                                <c:forEach items="${v.dlist }" var="v2">
                                                    <tr>
                                                        ...
                                                        <td style="width: 100px;"><c:choose>
                                                            <c:when test="${v.order_status==1 }"><p>待支付</button>
                                                            </c:when>
                                                            <c:when test="${v.order_status==3 }"><p>待发货</p></c:when>
                                                            <c:otherwise>aaa</c:otherwise>
                                                        </c:choose></td>
...
<script type="text/javascript">
    $(function() {
        $(".nexttrshowhide").click(function() {
            $(this).next("tr").toggleClass("mytg");
        });
